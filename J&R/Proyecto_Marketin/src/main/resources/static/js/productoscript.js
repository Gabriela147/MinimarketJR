  	...
  	modalBody.innerHTML = `
	    ...
	    <div class="mb-3">
     	...
     	<div class="mb-3">
        	...
        	<input type="text" class="form-control" id="editPrecio" value="${productoDetalles.precioCompra}" />
     	</div>
     	
     	<div class="mb-3">
        	<label for="editNombre" class="col-form-label">Precio Venta:</label>
        	<input type="text" class="form-control" id="editPrecioVenta" value="${productoDetalles.precioVenta}" />
     	</div>
